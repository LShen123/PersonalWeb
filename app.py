...
from model import train_and_predict_linear, train_and_predict_logistic, plot_resultsLin, plot_resultsLog
...
def regression():
    ...
    plot_url_log = plot_resultsLog(y_test_log, pred_log, iris)
